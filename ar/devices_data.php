...
<head>
    ...
    <link rel="stylesheet" href="../css/store/store_data.css">
        ...
        <div class="show-board">
            ...
            <div class="data-info">
                <div class="box">
                    <div class="data">
                        <p>معدات الشركة</p>
                        <span id="allDevices"></span>
                    </div>
                </div>
                <div class="box">
                    <div class="data">
                        <p>معدات المخزن</p>
                        <span id="store_Devices"></span>
                    </div>
                </div>
                <div class="box">
                    <div class="data">
                        <p>معدات السوق</p>
                        <span id="ON_Devices"></span>
                    </div>
                </div>
                <div class="box">
                    <div class="data">
                        <p>خارج الصيانة</p>
                        <span id="Maintenance_Devices"></span>
                    </div>
                </div>
            </div>
            ...
            <form novalidate>
                ...
                <div class="form-row py-3">
                    <div class="col-xl-12 col-md-9 col-sm-auto inputs-group">
                        ...
                        <div class="form-group">
                            <label for="reimel">رقم هوية IMEI</label>
                            <input type="text" class="form-control" id="reimel">
                        </div>
                        <div class="form-group">
                            <label for="resn">SN</label>
                            <input type="text" class="form-control " id="resn">
                        </div>
                        <div class="form-group">
                            <label for="retypeOfdevice">نوع الجهاز</label>
                            <input type="text" class="form-control " id="retypeOfdevice">
                        </div>
                        <div class="form-group">
                            <label for="restateOfdevice">الحالة</label>
                            <select class="form-control " id="restateOfdevice" onchange="paydash(this.value)">
                                <option value=""></option>
                        ...
                        <div class="form-group">
                            <label for="retypeOfpay">نوع الدفع</label>
                            <select class="form-control " id="retypeOfpay">
                                <option value="-">-</option>
                                <option value="تأمين">تأمين</option>
                                <option value="تقسيط">تقسيط</option>
                                <option value="كاش">كاش</option>
                                <option value="فري">فري</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="repaydate">تاريخ الدفع</label>
                            <input type="text" class="form-control " id="repaydate">
                        </div>
                        <div class="form-group">
                            <label for="repayvalue"> قيمة المدفوع</label>
                            <input type="text" class="form-control " id="repayvalue">
                        </div>
                        <div class="form-group">
                            <label for="retraderCode">معرف التاجر</label>
                            <input type="text" class="form-control " id="retraderCode">
                        </div>
                        <div class="form-group">
                            <label for="retraderName">اسم التاجر</label>
                            <input type="text" class="form-control " id="retraderName">
                        </div>
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary ml-2 w-100" data-dismiss="modal" id="save"
                        onclick="saveData(tmp)">تسجيل</button>
                    <button type="button" class="btn btn-primary ml-2 w-100" data-dismiss="modal" id="clear"
                        onclick="clearinput()">تنظيف</button>
                </div>
                <div>
                    <div class="input-group is-invalid">
                        <input class="form-control my-2" style="height: 38px;" type="search" placeholder="البحث بالمعرف"
                            id="searchInput" oninput="searchOperation(this.value)" aria-label="Search">
                        <select class="select my-2" aria-label="search_items" id="search_items"
                            onchange="getsearchMood(this.value)">
